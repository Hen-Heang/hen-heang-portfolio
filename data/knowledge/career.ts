    ...
    return [
        {
            ...
            keywords: ["journey", "career journey", "career path", "story", "timeline", "cambodia", "korea", "move", "moved", "relocated", "background", "how did he start", "rupp", "hrd"],
            ...
            content: [
                ...
                "",
                "Throughout, his career direction has stayed backend-first: each step (Cambodia training → KOSIGN → Bizplay) deepened Java, Spring Boot/MyBatis, and relational databases. He is now adding AX Engineering through AI-assisted development and structured learning in Agent Harness, MCP, evaluations, DevOps, and system architecture—not replacing the backend foundation.",
            ].join("\n"),
        },
        {
            ...
            keywords: ["confidential", "nda", "can't share", "cannot share", "source code", "company code", "screenshots", "proprietary", "private", "internal", "bizplay project", "kosign project", "employer work"],
            content: ["Heang's employer work at Bizplay and KOSIGN involves proprietary business systems — the source code, internal URLs, customer data, and production details belong to those companies and aren't shareable, the same way any employee's day job code isn't public.", "", "What can be discussed instead: his responsibilities and the technologies used — Java, MyBatis, Spring Boot, Spring Security/JWT, PostgreSQL, Oracle, SQL query design and optimization, and enterprise frontend work with JavaScript/jQuery — plus the general shape of the systems (government-facing financial web applications at Bizplay; a B2B billing platform integrated with banking systems at KOSIGN). For code-level detail, his personal projects (H-Phsar, AuthHub, Hengo, Money Flow) are fully public on GitHub and cover the same stack."].join("\n"),
        },
    ]
}
